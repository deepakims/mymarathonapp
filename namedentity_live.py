...
mapping_file ='../input/mypickle.pkl'
...
def model_production_live():
    # model_testing_sentences = ['Jay is from India','Donald is the president of USA']
    data=request.get_json(force=True)
    #parameters
    model_testing_sentences = [data['s']]
    lower='True' #parameters['lower']
    # This load reload the trained model
    model_name='' #path of the pre-trained model
...
# model_production_live("hello hi")
